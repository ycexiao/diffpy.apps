...
# -*- coding: utf-8 -*-
#
# diffpy.apps documentation build configuration file, created by  # noqa: E501
...
try:
    fullversion = version("diffpy.apps")
except Exception:
...
# abbreviations
ab_authors = "Yuchen Xiao, Simon Billinge and members of the Billinge group"
...
project = "diffpy.apps"
copyright = "%Y, diffpy.apps contributors"
...
modindex_common_prefix = ["diffpy.apps"]
...
basename = "diffpy.apps".replace(" ", "").replace(".", "")
